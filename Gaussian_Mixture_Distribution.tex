...
在问题二中，我们选用参数 $\mu_1 = 0, \sigma_1 = 2; \mu_2 = 10, \sigma_2 = 3; p = 0.6$。利用 Matlab，按照第三节的方法可以生成服从混合高斯分布的矩阵，再对每行计算 $U_i$，代码“GM\_gen\_U.m” 如下：

\lstinputlisting{GM_gen_u.m}
...
对于问题二，我们分别选取了$n = 10, n = 20, n = 50, n = 100$ 和 $n = 1000$ 进行生成并计算，得到的数据全部存储在 data 文件夹下的 data5-1.csv, data5-2.csv, ..., data5-5.csv 中，并画出$U_i$ 的频率分布直方图如图 \ref{fig5} 所示。
